...
function writeUserPwd(){
	document.getElementById("userPwdMsg").innerHTML = "密码为数字或字母，长度为4-20";
...
function form_submit() {
	...
	if(identity=="" || identity.length < 18){
		flag=false;
		document.getElementById("identityMsg").innerHTML = "身份证不能为空,且为18位";
	}
	
	
	if(phone=="" || phone.length < 11){
		flag=false;
		document.getElementById("phoneMsg").innerHTML = "联系电话不能为空,且为11位";
	}
