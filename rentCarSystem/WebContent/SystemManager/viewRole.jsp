	...
	<body>
		<form action="updateRole.do" method="post">
			...
			<input type="hidden" name="roleId"
				value="${requestScope.role.roleId}">
				...
				<table>
					<tr>
						<td>
							...
							角色名称：
							<input type="text" name="roleName1"
								value="${requestScope.role.roleName }" id="roleName" />
							<br />
